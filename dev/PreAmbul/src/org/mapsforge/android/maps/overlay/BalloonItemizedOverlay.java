...
public abstract class BalloonItemizedOverlay<Item extends OverlayItem> extends ItemizedOverlay<Item> {
	 ...
	 */
	protected abstract boolean onBalloonTap(int index, Item item);
	 ...
	 */
	protected abstract void onBalloonOpen(int index);
	...
	public void setLastFocusedIndex(int index) {
	...
	public void hideBalloon() {
		...
		onBalloonClosed(currentFocusedIndex);
		currentFocusedItem = null;
	}
	
	public abstract void onBalloonClosed(int index);
	...
	private boolean createAndDisplayBalloonOverlay(){
		...
		if (balloonView == null) {
			...
			closeRegion = (View) balloonView.findViewById(R.id.balloon_buttons);
			if (closeRegion != null) {
				if (!showClose) {
		...
		if (currentFocusedItem != null)
			balloonView.setData(currentFocusedItem, isPlayable);
		
		GeoPoint point = currentFocusedItem.getPoint();
		Point poiPoint = null;
		poiPoint = mapView.getProjection().toPixels(mapView.getMapPosition().getMapCenter(), poiPoint);
		MapView.LayoutParams params = new MapView.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, point,
				MapView.LayoutParams.BOTTOM_CENTER, -poiPoint.x, -poiPoint.y);
	...
	public static Drawable boundLeftCenter(Drawable balloon) {
        balloon.setBounds(0, -balloon.getIntrinsicHeight(),
                        balloon.getIntrinsicWidth(), 0);
        return balloon;
	}
