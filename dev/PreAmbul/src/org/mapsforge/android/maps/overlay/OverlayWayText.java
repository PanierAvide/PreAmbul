...
public class OverlayWayText {
         ...
         */
        public OverlayWayText() {
                this(null, null, null, null);
        }
        
        /**
         * Class constructor
         * @param ovw An OverlayWay object, attributes will be copied
         * @param text The text to display on path
         */
        public OverlayWayText(OverlayWay ovw, String text) {
        	this(ovw.wayNodes, text, ovw.paintFill, ovw.paintOutline);
        }

        /**
         * @param wayNodes
         *            the geographical coordinates of the way nodes, must not contain null elements.
         * @param overlayText The text to display on path
         * @throws IllegalArgumentException
         *             if the way nodes contain at least one null element.
         */
        public OverlayWayText(GeoPoint[][] wayNodes, String overlayText) {
                this(wayNodes, overlayText, null, null);
        }
         ...
         *             if the way nodes contain at least one null element.
         */
        public OverlayWayText(GeoPoint[][] wayNodes, String overlayText, Paint paintFill, Paint paintOutline) {
         ...
         *             if the way nodes contain at least one null element.
         */
        public OverlayWayText(Paint paintFill, Paint paintOutline) {
                this(null, null, paintFill, paintOutline);
        }
