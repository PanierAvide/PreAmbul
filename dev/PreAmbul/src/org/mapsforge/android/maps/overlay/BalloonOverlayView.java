...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	protected void setupView(Context context, final ViewGroup parent) {
		...
		icon = (ImageView) v.findViewById(R.id.bubbleIcon);
		playable = (ImageView) v.findViewById(R.id.balloon_playable);
	 ...
	 */
	public void setData(Item item, boolean isPlayable) {
		layout.setVisibility(VISIBLE);
		setBalloonData(item, layout, isPlayable);
	}
	 ...
	 */
	protected void setBalloonData(Item item, ViewGroup parent, boolean isPlayable) {
		...
		if(item.getMarker() != null) {
			...
			icon.setImageDrawable(item.getMarker());
		} else {
			icon.setImageDrawable(null);
			icon.setVisibility(GONE);
		}
		if(isPlayable) {
			playable.setVisibility(VISIBLE);
		} else {
			playable.setVisibility(INVISIBLE);
		}
	}
