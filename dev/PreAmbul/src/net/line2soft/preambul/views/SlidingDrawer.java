...
public class SlidingDrawer extends ViewGroup {
    ...
    public SlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        //Here we initialize the new maxHeight variable (using a default value of 200)
        mMaxHeight = (int) a.getDimension(R.styleable.MySlider_SlidingDrawer_maxHeight, 200.0f);
